...
@interface EditTransactionViewController (PrivateMethod)
- (void)showMenu;
...
- (UITextField *)expenseField {
	...
	if (expenseField == nil) {
        ...
        expenseField.text = [SplendidUtils currencyIDFormatWithString:[self.expense.expenseAmount description]];
...
- (void)showMenu {
    ...
    UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:@"Additional Info" delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:@"Take Photo..." otherButtonTitles:@"Photo from Library...", @"Add Location", notes, nil];
