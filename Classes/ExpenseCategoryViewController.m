//
//  ExpenseCategoryViewController.m
//  Splendid
//
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"ExpenseCategory"
                                              inManagedObjectContext:self.expense.managedObjectContext];
    ...
    NSError *error = nil;
    NSArray *fetchedObjects = [self.expense.managedObjectContext executeFetchRequest:fetchRequest error:&error];
    if (fetchedObjects == nil) {
        // Handle the error
    }
    
    self.expenseCategories = fetchedObjects;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSManagedObject *categories = [self.expenseCategories objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSManagedObject *currentCategory = expense.category;
    
    if (currentCategory != nil) {
        // deselect the current checkmarked cell
        NSInteger index = [expenseCategories indexOfObject:currentCategory]; // get the index of current choosed category
    ...
    expense.category = [expenseCategories objectAtIndex:indexPath.row];
